 ...
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_setupAudioStreamNative(
...
Java_com_bda_myapplication_DrumPlayer_startAudioStreamNative(
 ...
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_teardownAudioStreamNative(JNIEnv* , jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_loadWavAssetNative(
 ...
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_unloadWavAssetsNative(JNIEnv* env, jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_trigger(JNIEnv* env, jobject, jint index) {
 ...
 * Native (JNI) implementation of DrumPlayer.trigger()
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_stopTrigger(JNIEnv* env, jobject, jint index) {
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_bda_myapplication_DrumPlayer_getOutputReset(JNIEnv*, jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_clearOutputReset(JNIEnv*, jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_restartStream(JNIEnv*, jobject) {
sDTPlayer.resetAll();
...
JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_setPan(
JNIEnv *env, jobject thiz, jint index, jfloat pan) {
sDTPlayer.setPan(index, pan);
}

JNIEXPORT jfloat JNICALL Java_com_bda_myapplication_DrumPlayer_getPan(
JNIEnv *env, jobject thiz, jint  index) {
return sDTPlayer.getPan(index);
}

JNIEXPORT void JNICALL Java_com_bda_myapplication_DrumPlayer_setGain(
JNIEnv *env, jobject thiz, jint  index, jfloat gain) {
sDTPlayer.setGain(index, gain);
}

JNIEXPORT jfloat JNICALL Java_com_bda_myapplication_DrumPlayer_getGain(
JNIEnv *env, jobject thiz, jint index) {
